...
public class RegistroHuesped extends JFrame {
	...
	private JComboBox<Format> txtNacionalidad = null;
	...
	public RegistroHuesped() {
		...
		btnguardar.setBounds(641, 498, 122, 35);
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				java.sql.Date FECHA_NACIMIENTO = new java.sql.Date(fechaNacimiento.getTime());
				...
				Huesped registro = new Huesped(nombre, apellido, FECHA_NACIMIENTO, nacionalidad, telefono);
				
				HuespedController huespedController = new HuespedController();
				huespedController.registrarHuesped(registro);
