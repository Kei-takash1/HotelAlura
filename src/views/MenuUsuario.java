...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		btnBusqueda.setBounds(1, 392, 257, 56);
		...
		btnHuespedes.setBackground(new Color(12, 138, 199));
		btnHuespedes.setBounds(0, 327, 257, 56);
		panelMenu.add(btnHuespedes);
		
		JLabel lblRegistroDeHuespedes = new JLabel("Registro de huespedes");
		lblRegistroDeHuespedes.setIcon(new ImageIcon(MenuUsuario.class.getResource("/imagenes/perfil-del-usuario.png")));
		lblRegistroDeHuespedes.setHorizontalAlignment(SwingConstants.LEFT);
		lblRegistroDeHuespedes.setForeground(Color.WHITE);
		lblRegistroDeHuespedes.setFont(new Font("Dialog", Font.PLAIN, 18));
		lblRegistroDeHuespedes.setBounds(25, 11, 222, 34);
		btnHuespedes.add(lblRegistroDeHuespedes);
		...
		btnHuespedes.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
